...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/blue-morning-d336)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/blue-morning-d336
```

A live public deployment of this template is available at [https://blue-morning-d336.templates.workers.dev](https://blue-morning-d336.templates.workers.dev)
